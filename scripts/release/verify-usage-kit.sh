...
required_paths=(
  ...
  "usage-kit/samples/20-provider-capability-p0/data/jdbc/env_profiles/external_jdbc_env_secret_ref.yaml"
  ...
  "usage-kit/samples/provider_capability/jdbc/env_profiles/external_jdbc_env_secret_ref.yaml"
