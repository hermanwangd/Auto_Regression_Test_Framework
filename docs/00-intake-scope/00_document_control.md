...
| Version | v0.2 |
| Status | Full Pre-release Scope Draft |
| Owner | TBD |
...
- Use `project_scope_capability_baseline.md` to align v0.2 full pre-release scope and framework/product/agent boundaries.
