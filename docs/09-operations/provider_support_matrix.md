...
| `wiremock_http_mock` | `supported` | `samples/20-provider-capability-p0/http/wiremock_http_mock/` | Framework-managed WireMock HTTP mock; external base URL support is tracked by the v0.2.4 release plan. |
