...
| Packaged CLI smoke verification | Spring Boot jar CLI entrypoint | `java -jar target/spec-driven-auto-regression-0.2.7.jar validate --suite samples/20-provider-capability-p0/suite_manifest.yaml --profile local_provider` | Checked-in suite-mode framework sample fixture | CLI output and exit code. |
