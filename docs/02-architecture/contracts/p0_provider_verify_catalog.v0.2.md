...
Provider naming is mandatory in v0.2 public contracts. Public docs must describe `jdbc`, `nats_messaging`, and other runtime targets as Provider Contracts and Provider Instances.
