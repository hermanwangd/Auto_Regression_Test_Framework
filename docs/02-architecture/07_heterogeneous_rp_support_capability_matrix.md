...
| Oracle/assertion | File diff, expected-result artifact path, and JSON path equality assertions | JSON path, schema, contract, DB row, absence, tolerance | Add schema, contract, DB row, absence, and tolerance assertion providers incrementally |
