...
| Execution adapter | Provider runtime registry dispatches file/batch shell, REST, local/mock messaging, native Kafka/NATS publish messaging, JDBC DB fixture, local/mock plus native K8s/VM deployment readiness, and approved command-runner escape hatch paths | Provider-registry-dispatched REST/gRPC, Kafka/NATS, DB, deployment readiness, and shell/file providers | Add native gRPC, Kafka/NATS consume/observe, and richer K8s/VM readiness as reusable runtimes |
