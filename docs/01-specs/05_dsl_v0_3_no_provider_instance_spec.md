...
**Status:** v0.3.0 public preview and P0 assertion/reference hardening implemented. The v0.3.0 semantic-contract completion scope below remains planned.
...
## 12. v0.3.0 Semantic Contract Completion Scope
